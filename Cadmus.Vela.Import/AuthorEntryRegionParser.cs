...
public sealed class ColAuthorEntryRegionParser : EntryRegionParser,
    IEntryRegionParser
{
    private const string COL_AUTHOR = "autore";

    private readonly ILogger<ColAuthorEntryRegionParser>? _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="ColAuthorEntryRegionParser"/>
    /// class.
    /// </summary>
    /// <param name="logger">The logger.</param>
    public ColAuthorEntryRegionParser(
        ILogger<ColAuthorEntryRegionParser>? logger = null)
    {
        _logger = logger;
    }
