...
/// <summary>
/// VeLA column tipo_figurativo entry region parser. This targets
/// <see cref="GrfFramePart.Figure"/>.
/// </summary>
/// <seealso cref="EntryRegionParser" />
/// <seealso cref="IEntryRegionParser" />
[Tag("entry-region-parser.vela.col-tipo_figurativo")]
    ...
    IEntryRegionParser
{
        ...
        int regionIndex)
    {
        ...
        {
            _logger?.LogError("tipo_figurativo column without any item " +
                "at region {region}", region);
            throw new InvalidOperationException(
                "tipo_figurativo column without any item at region " + region);
        }
